      ...
      return (
        <div className="bg-gradient-to-b from-[#0b0c1b] to-[#07061c] text-white font-sans min-h-screen">
          <header className="flex justify-between items-center px-4 sm:px-6 md:px-8 py-4 border-b border-gray-700">
            <img src="/logo.svg" alt="AcadChain Logo" className="h-6 sm:h-8 w-auto" />
            <motion.button
          ...
          <section className="relative w-full min-h-[80vh] sm:min-h-screen flex items-center justify-center bg-[#0B0B15] overflow-hidden">
            ...
            >
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-4 sm:px-6 py-2 sm:py-3 bg-blue-600 hover:bg-blue-700 transition text-white font-semibold rounded-lg cursor-pointer text-sm sm:text-base"
              >
                Whitepaper
              </motion.button>
            </motion.div>
          ...
          <section className="flex flex-col md:flex-row justify-between items-center px-4 sm:px-8 md:px-16 py-12 sm:py-16 space-y-10 md:space-y-0 md:space-x-8 lg:space-x-12">
            ...
            >
              ...
              >
                AcadChain is a decentralized education protocol revolutionizing learning and skill verification through blockchain. It enables tokenized learning, decentralized governance, and zk-proof-based certifications.
                To ensure scalability, security, and interoperability, we're building AcadChain—a dedicated subnet on Avalanche's P-Chain—empowering global, verifiable, and accessible education.
              </motion.p>
              <motion.button
                variants={textVariants}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-blue-600 px-3 sm:px-4 py-2 rounded hover:bg-blue-700 text-xs sm:text-sm cursor-pointer rounded-lg"
              >
                Know More
              </motion.button>
            </motion.div>
          ...
          <section className="relative mx-4 sm:mx-8 md:mx-12 lg:mx-16 my-12 sm:my-16 p-4 sm:p-6 md:p-8 lg:p-12 rounded-3xl bg-[#0A0F2C] flex flex-col md:flex-row items-center space-y-10 md:space-y-0 md:space-x-8 lg:space-x-12 border border-blue-500 shadow-[0_0_20px_5px_rgba(0,102,255,0.5)]">
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.3 }}
            >
              <img src="/assets/goal.svg" alt="Trophy and Target" className="w-full max-w-[200px] sm:max-w-[250px] md:max-w-[300px]" />
            </motion.div>
            <motion.div
            ...
            >
              ...
              >
                ...
                >
                  <img src="/assets/check.svg" alt="Check Icon" className="w-5 h-5 sm:w-6 sm:h-6 mt-0.5" />
                  <p>Tokenized educational experiences connecting learners, educators, and employers.</p>
                </motion.li>
                <motion.li
                  variants={textVariants}
                  className="flex items-start gap-2 sm:gap-3"
                ...
                >
                  <img src="/assets/check.svg" alt="Check Icon" className="w-5 h-5 sm:w-6 sm:h-6 mt-0.5" />
                  <p>Interactive achievements, quizzes, XP rewards, and user-driven content.</p>
                </motion.li>
              </motion.ul>
            </motion.div>
          </section>
          ...
          <section className="relative mx-4 sm:mx-8 md:mx-12 lg:mx-16 my-12 sm:my-16 p-4 sm:p-6 md:p-8 lg:p-12 rounded-3xl bg-[#0A0F2C] flex flex-col md:flex-row items-center space-y-10 md:space-y-0 md:space-x-8 lg:space-x-12 border border-blue-500 shadow-[0_0_20px_5px_rgba(0,102,255,0.5)]">
            ...
            >
              ...
              >
                Connect with innovators, and be part of the movement. Get exclusive early access and stay updated on launch news.
              </motion.p>
              <motion.button
                variants={textVariants}
                whileHover={{ scale: 1.05 }}
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.3 }}
            >
              <img src="/assets/rafiki.svg" alt="Community" className="w-full max-w-[200px] sm:max-w-[250px] md:max-w-[300px]" />
            </motion.div>
          </section>
